...
public class CRUDController {
	 ...
	 */
	@GetMapping("/admin/sporty/shoe/{id}")
	 ...
	 */
	@DeleteMapping("/admin/sporty/shoe/{id}")
	 ...
	 */
	@PostMapping("/admin/purchase/Report")
	 ...
	 */
	@GetMapping("/admin/purchase/Report/id/{id}")
	 ...
	 */
	@PutMapping("/admin/purchase/Report")
	 ...
	 */
	@DeleteMapping("/admin/purchase/Report/{id}")
