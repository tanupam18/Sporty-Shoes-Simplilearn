...
public class PurchaseReport {
	...
	@GeneratedValue
	private int id;
	private String purchasedBy; // This can be extended to utilize one to one relation with User Table [Future
								// Implemetations]
	...
	/**
	 * This can be used for storing orderlist as <Qty, Shoe> Here implementation is
	 * made simple by using shoeId instead of shoe in string format.
	 */
